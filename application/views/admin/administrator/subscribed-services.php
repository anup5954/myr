...
<h3 class="card-title">Subscribed Services List</h3>
...
foreach( $services_subscribed as $group ) {

$customer_id=$this->mdl->fetch_group_name_by_id( $group->customer_id );
...
<td><?=  $this->mdl->fetch_group_name_by_id( $group->customer_id ); ?></td>
