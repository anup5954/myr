...
<a href="<?= base_url('services_compare_points/list') ?>" class="btn btn-danger btn-sm"><i class="fa fa-undo" aria-hidden="true"></i> Back</a>
...
echo form_open_multipart( 'services_compare_points/update/'.$this->uri->segment(3) );
}else{
echo form_open_multipart('services_compare_points/insert');
}
?>
