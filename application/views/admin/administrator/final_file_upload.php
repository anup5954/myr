...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-options">
            <a href="<?= base_url('orders/assigned') ?>" class="btn btn-danger btn-sm"><i class="fa fa-undo" aria-hidden="true"></i> Back</a>
        </div>
    </div>
    <?php
    ...
    ?>
        <div class="card-body">
            <div class="col-md-12 col-xl-12">
                <?php echo form_open_multipart('admin-orders/insert_final_doc') ?>
